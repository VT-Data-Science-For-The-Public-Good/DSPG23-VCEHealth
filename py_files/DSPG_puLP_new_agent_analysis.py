...
na_snap_districts = pd.read_csv('C:/Users/macary/Documents/DSPG/Health_2023/data/district_new_agent_matrix_snap.csv')
...
" Keep this as baseline + new agents "

" Re-run with snap agents only as baseline  + new agents "

" Re-run again with non-snap agents only as baseline  + new agents "

" This means I need to re-work the baseline script and note the OF vals "
...
agents_df.to_csv('C:/Users/macary/Documents/DSPG/Health_2023/agent_descriptive_statistics_________.csv', index = False)
